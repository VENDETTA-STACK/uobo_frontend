...
import AddTeamsForm1 from "../components/AddTeamsForm1";

const SignupSetup10Child = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
const Skip = styled.div`
  ...
  display: none;
`;
const SignupSetup10Item = styled.img`
  position: absolute;
  top: 232px;
  left: 816px;
  width: 37px;
  ...
  display: none;
`;
const SignupSetup10Inner = styled.div`
  position: absolute;
  top: 0px;
  left: -2px;
  background-color: var(--color-white);
...
const LineDiv = styled.div`
  ...
  height: 49px;
`;
const SignupSetup10Child1 = styled.div`
  position: absolute;
  top: 169.5px;
  left: 974.5px;
...
`;
const WhoWillBe = styled.span`
  text-decoration: underline;
`;
const AddYourTeamContainer = styled.div`
  position: absolute;
  top: 155px;
  left: 62px;
...
const ButtonLoginChild = styled.div`
  ...
  height: 51px;
`;
const SaveAndProceed = styled.div`
  position: absolute;
  top: 7px;
  left: 29px;
...
const RectangleDiv = styled.div`
  ...
  height: 59px;
`;
const AddAnotherTeam = styled.div`
  position: absolute;
  top: 15px;
  left: 138.6px;
...
const PleaseUploadAn = styled.div`
  ...
  width: 528px;
`;
const SignupSetup10Root = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 768px;
...
const SignupSetup10 = () => {
  return (
    <SignupSetup10Root>
      <SignupSetup10Child />
      <Skip>Skip</Skip>
      <SignupSetup10Item alt="" src="/group-10576.svg" />
      <SignupSetup10Inner />
      <LineDiv />
      <SignupSetup10Child1 />
      <EllipseParent>
      ...
      <EllipseGroup>
        ...
        <Path1152Icon1 alt="" src="/path-1152.svg" />
        <Div1>3</Div1>
      </EllipseGroup>
      <EllipseContainer>
        <GroupChild alt="" src="/ellipse-2051.svg" />
      ...
      <Skip1>Skip</Skip1>
      <MemberCountCard propLeft="calc(50% - 28.85px)" />
      <AddYourTeamContainer>
        {`Add your team members here, `}
        <WhoWillBe>who will be using Uobo</WhoWillBe>.
      </AddYourTeamContainer>
      <Uobo>UOBO</Uobo>
      <TextWelcome>
        <AFewMore>
      ...
      <YouCanSkip>
        You can skip this step and do later from your dashboard settings.
      </YouCanSkip>
      <ButtonLogin>
        <ButtonLoginChild />
        <SaveAndProceed>Save and proceed</SaveAndProceed>
      </ButtonLogin>
      <RectangleParent>
        <RectangleDiv />
        <AddAnotherTeam>Add another team member</AddAnotherTeam>
        <GroupIcon alt="" src="/group-10573.svg" />
      </RectangleParent>
      <AddTeamsForm1 />
      <PleaseUploadAn>
