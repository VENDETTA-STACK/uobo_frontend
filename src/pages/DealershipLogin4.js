...
import SorryUserNotFoundContainer from "../components/SorryUserNotFoundContainer";
import FormContainer2 from "../components/FormContainer2";

const DealershipLogin4Child = styled.div`
  position: absolute;
  top: 0px;
  left: -2px;
...
`;
const Jvinkshygmailcom = styled.div`
  position: absolute;
  top: calc(50% - 5.5px);
  left: 59.41px;
...
`;
const NewToUobo = styled.span``;
const JoinNow = styled.span`
  text-decoration: underline;
  color: var(--color-royalblue-100);
`;
const NewToUoboContainer = styled.div`
  position: absolute;
  top: 596.5px;
  left: 716px;
  font-size: var(--font-size-xl);
...
const Uobo = styled.div`
  ...
  text-align: left;
`;
const RedefiningTheAutomative = styled.div`
  position: absolute;
  top: 71px;
  left: 50px;
  ...
  width: 340px;
`;
const SorryWeCouldnt = styled.div`
  position: absolute;
  top: 326.5px;
  right: 164px;
  letter-spacing: 0.26px;
...
const TextWelcome = styled.div`
  ...
  font-size: var(--font-size-xl);
`;
const DealershipLogin4Root = styled.div`
  position: relative;
...
`;
const DealershipLogin4 = () => {
  return (
    <DealershipLogin4Root>
      <DealershipLogin4Child />
      <Path3022Icon alt="" src="/path-3020.svg" />
      <RectangleParent>
        <GroupChild />
        <IconGmail alt="" src="/icon--gmail.svg" />
        <Email>Email</Email>
        <Jvinkshygmailcom>jvinkshy@gmail.com</Jvinkshygmailcom>
      ...
      <NewToUoboContainer>
        <NewToUobo>{`New to Uobo? `}</NewToUobo>
        <JoinNow>Join Now</JoinNow>
      </NewToUoboContainer>
      <SorryUserNotFoundContainer dimensions="/group-105201.svg" />
      <TitleWeBelieve>Login</TitleWeBelieve>
      <ToAccessYour>to access your dashboard</ToAccessYour>
      <Uobo>UOBO</Uobo>
      <RedefiningTheAutomative>
        Redefining the automative industry
      </RedefiningTheAutomative>
      <SorryWeCouldnt>
        Sorry, we could'nt find a registered user for this email.
      </SorryWeCouldnt>
      <KeepMeLoggedInParent>
        <KeepMeLogged>Keep me logged in</KeepMeLogged>
        <EllipseWrapper>
          <GroupItem alt="" src="/ellipse-331.svg" />
        </EllipseWrapper>
      </KeepMeLoggedInParent>
      ...
      <TextWelcome>
        <SellYourCarsContainer>
          <NewToUobo>
            ...
            <WithJustA>
              <NewToUobo>{`few `}</NewToUobo>
            </WithJustA>
          </NewToUobo>
          <WithJustA>
            <NewToUobo>
              <NewToUobo>clicks</NewToUobo>
            </NewToUobo>
          </WithJustA>
        </SellYourCarsContainer>
...
export default DealershipLogin4;
