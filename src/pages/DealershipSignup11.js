...
import DealershipTypeForm3 from "../components/DealershipTypeForm3";
import ContainerForm from "../components/ContainerForm";

const DealershipSignup11Child = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
`;
const DealershipSignup11Item = styled.div`
  position: absolute;
  top: 0px;
  right: 2px;
...
const TitleWeBelieve = styled.div`
  ...
  text-align: center;
`;
const DealershipSignup11Inner = styled.div`
  position: absolute;
  top: 619px;
  right: 2px;
...
`;
const DealershipSignup11Root = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 1144px;
...
`;
const DealershipSignup11 = () => {
  return (
    <DealershipSignup11Root>
      <DealershipSignup11Child />
      ...
      <ContainerForm
        ...
        imageDimensions="/group-10549.svg"
        propOpacity="unset"
        propLeft="calc(50% - 32px)"
        propLeft1="calc(50% - 60.83px)"
      />
      <DealershipSignup11Item />
      <TitleWeBelieve>Get Started</TitleWeBelieve>
      <DealershipSignup11Inner />
      <ButtonLogin>
        <ButtonLoginChild />
...
export default DealershipSignup11;
