...
const SignupSetup5Child = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
const Skip = styled.div`
  ...
  display: none;
`;
const SignupSetup5Item = styled.div`
  position: absolute;
  top: 0px;
  left: -2px;
  background-color: var(--color-white);
  ...
  height: 768px;
`;
const SignupSetup5Inner = styled.div`
  position: absolute;
  top: 247.5px;
  left: 974.5px;
...
const LineDiv = styled.div`
  ...
  height: 59px;
`;
const SignupSetup5Child1 = styled.div`
  position: absolute;
  top: 169.5px;
  left: 974.5px;
...
const ButtonProceed = styled.div`
  ...
  font-size: var(--font-size-5xl);
`;
const SignupSetup5Root = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 768px;
