...
const SignupSetup102Child = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
const Skip = styled.div`
  ...
  display: none;
`;
const SignupSetup102Item = styled.img`
  position: absolute;
  top: 232px;
  left: 816px;
  width: 37px;
  ...
  display: none;
`;
const SignupSetup102Inner = styled.div`
  position: absolute;
  top: 0px;
  left: -2px;
  background-color: var(--color-white);
...
const LineDiv = styled.div`
  ...
  height: 49px;
`;
const SignupSetup102Child1 = styled.div`
  position: absolute;
  top: 169.5px;
  left: 974.5px;
...
const RectangleParent = styled.div`
  ...
  color: var(--color-royalblue-100);
`;
const SignupSetup102Root = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 768px;
...
`;
const SignupSetup102 = () => {
  return (
    <SignupSetup102Root>
      <SignupSetup102Child />
      <Skip>Skip</Skip>
      <SignupSetup102Item alt="" src="/group-10576.svg" />
      <SignupSetup102Inner />
      <LineDiv />
      <SignupSetup102Child1 />
      <EllipseParent>
