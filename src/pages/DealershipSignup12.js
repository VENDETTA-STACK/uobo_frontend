...
import DealershipTypeForm2 from "../components/DealershipTypeForm2";
import ContainerForm from "../components/ContainerForm";

const DealershipSignup12Child = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
const RedefiningTheAutomotive = styled.div`
  ...
  width: 340px;
`;
const DealershipSignup12Item = styled.div`
  position: absolute;
  top: 619px;
  right: 2px;
...
`;
const DealershipSignup12Inner = styled.div`
  position: absolute;
  top: 0px;
  right: 2px;
...
`;
const DealershipSignup12Root = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 1144px;
...
`;
const DealershipSignup12 = () => {
  return (
    <DealershipSignup12Root>
      <DealershipSignup12Child />
      ...
      <DealershipTypeForm2 />
      <DealershipSignup12Item />
      <ButtonLogin>
        <ButtonLoginChild />
        <Submit>Submit</Submit>
      </ButtonLogin>
      <DealershipSignup12Inner />
...
export default DealershipSignup12;
