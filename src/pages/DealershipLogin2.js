...
const DealershipLogin2Child = styled.div`
  position: absolute;
  top: 0px;
  left: -2px;
...
const RedefiningTheAutomative = styled.div`
  ...
  width: 340px;
`;
const DealershipLogin2Item = styled.div`
  position: absolute;
  top: 279.5px;
  left: 892.5px;
...
const TextWelcome = styled.div`
  ...
  height: 108px;
`;
const DealershipLogin2Root = styled.div`
  position: relative;
...
`;
const DealershipLogin2 = () => {
  return (
    <DealershipLogin2Root>
      <DealershipLogin2Child />
      <Path3021Icon alt="" src="/path-3020.svg" />
      <RectangleParent>
        <GroupChild />
        <IconGmail alt="" src="/icon--gmail.svg" />
        <Email>Email</Email>
        <Jevinkoshygm>jevinkoshy@gm</Jevinkoshygm>
      ...
      <SorryUserNotFoundContainer
        dimensions="/group-105201.svg"
        propTop="calc(50% - 7.18px)"
        propHeight="14.35px"
      />
...
export default DealershipLogin2;
