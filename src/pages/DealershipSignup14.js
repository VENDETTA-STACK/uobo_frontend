...
import DealershipTypeForm from "../components/DealershipTypeForm";
import FormContainer5 from "../components/FormContainer5";
import ContainerForm from "../components/ContainerForm";

const DealershipSignup14Child = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
const RedefiningTheAutomotive = styled.div`
  ...
  width: 340px;
`;
const DealershipSignup14Item = styled.div`
  position: absolute;
  top: 619px;
  right: 2px;
...
`;
const DealershipSignup14Inner = styled.div`
  position: absolute;
  top: 0px;
  right: 2px;
...
`;
const DealershipSignup14Root = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 1010px;
...
`;
const DealershipSignup14 = () => {
  return (
    <DealershipSignup14Root>
      <DealershipSignup14Child />
      ...
      <DealershipTypeForm />
      <DealershipSignup14Item />
      <ButtonLogin>
        <ButtonLoginChild />
        <Submit>Submit</Submit>
      </ButtonLogin>
      <DealershipSignup14Inner />
...
export default DealershipSignup14;
