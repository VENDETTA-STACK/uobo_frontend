...
const LiveOrdersBuyNowDocViewChild = styled.div`
  position: absolute;
  top: 85px;
  right: -8px;
  ...
  display: none;
`;
const LiveOrdersBuyNowDocViewItem = styled.div`
  position: absolute;
  top: 142px;
  right: 132px;
  ...
  height: 474px;
`;
const LiveOrdersBuyNowDocViewInner = styled.div`
  position: absolute;
  top: 137px;
  left: 212px;
...
const RectangleDiv = styled.div`
  ...
  display: none;
`;
const LiveOrdersBuyNowDocViewChild1 = styled.div`
  position: absolute;
  top: 0px;
  left: -2px;
  background-color: var(--color-white);
...
const LineDiv = styled.div`
  ...
  height: 769px;
`;
const LiveOrdersBuyNowDocViewChild2 = styled.div`
  position: absolute;
  top: 95px;
  left: -28px;
...
const EllipseIcon = styled.img`
  ...
  height: 8px;
`;
const LiveOrdersBuyNowDocViewChild3 = styled.div`
  position: absolute;
  top: 0px;
  right: 2px;
...
const NounNotification3408005Icon = styled.img`
  ...
  height: 27.64px;
`;
const LiveOrdersBuyNowDocViewChild4 = styled.div`
  position: absolute;
  top: 51.5px;
  left: 706.5px;
  ...
  display: none;
`;
const LiveOrdersBuyNowDocViewChild5 = styled.div`
  position: absolute;
  top: 51.5px;
  left: 205.5px;
  border-top: 1px solid var(--color-royalblue-100);
...
`;
const LiveOrdersBuyNowDocViewChild6 = styled.div`
  position: absolute;
  right: 80px;
  bottom: 3px;
...
`;
const LiveOrdersBuyNowDocViewChild7 = styled.div`
  position: absolute;
  top: 164.5px;
  left: 615.5px;
...
const Icon = styled.img`
  ...
  object-fit: cover;
`;
const LiveOrdersBuyNowDocViewChild8 = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
`;
const LiveOrdersBuyNowDocViewRoot = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 768px;
...
`;
const LiveOrdersBuyNowDocView = () => {
  const navigate = useNavigate();

  const onLiveOrdersBuyNowDocViewContainerClick = useCallback(() => {
    navigate("/live-orders-buy-now-1");
  }, [navigate]);

  return (
    <LiveOrdersBuyNowDocViewRoot
      onClick={onLiveOrdersBuyNowDocViewContainerClick}
    >
      <LiveOrdersBuyNowDocViewChild />
      <LiveOrdersBuyNowDocViewItem />
      <LiveOrdersBuyNowDocViewInner />
      <RectangleDiv />
      <LiveOrdersBuyNowDocViewChild1 />
      <LineDiv />
      <LiveOrdersBuyNowDocViewChild2 />
      ...
      />
      <LiveOrdersBuyNowDocViewChild4 />
      <LiveOrdersBuyNowDocViewChild5 />
      <MrDoeWrapper>
        <MrDoe>Mr. Doe</MrDoe>
      </MrDoeWrapper>
      <LiveOrdersBuyNowDocViewChild6 />
      <EllipseParent>
      ...
      <DocumentUploadForm1
        imageDimensions="/2figure115@2x.png"
      ...
      <LiveOrdersBuyNowDocViewChild7 />
      <Icon alt="" src="/19@2x.png" />
      <LiveOrdersBuyNowDocViewChild8 />
      <RectangleIcon alt="" src="/rectangle-2935@2x.png" />
      <DriversLicenseFront>Driver's License (Front)</DriversLicenseFront>
    </LiveOrdersBuyNowDocViewRoot>
  );
};

export default LiveOrdersBuyNowDocView;
