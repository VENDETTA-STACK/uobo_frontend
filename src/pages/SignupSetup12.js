...
import InventoryFeedContainer from "../components/InventoryFeedContainer";

const SignupSetup12Child = styled.div`
  position: absolute;
  top: 0px;
  left: 0px;
...
const Skip = styled.div`
  ...
  display: none;
`;
const SignupSetup12Item = styled.div`
  position: absolute;
  top: 0px;
  left: -2px;
  background-color: var(--color-white);
  ...
  height: 768px;
`;
const SignupSetup12Inner = styled.div`
  position: absolute;
  top: 247.5px;
  left: 974.5px;
...
const Path3975Icon = styled.img`
  ...
  opacity: 0.45;
`;
const SignupSetup12Child1 = styled.div`
  position: absolute;
  top: 134.5px;
  left: -2px;
...
`;
const UploadYourInventory = styled.div`
  position: absolute;
  top: calc(50% - 15px);
  ...
  line-height: 22px;
`;
const UploadYourInventoryFeedFilWrapper = styled.div`
  position: absolute;
  top: 156px;
  left: 62px;
  width: 383px;
...
`;
const YourInventoryFeed = styled.div`
  position: absolute;
  top: 637px;
  left: 146px;
  font-size: var(--font-size-mini);
...
const ButtonLogin = styled.div`
  ...
  font-size: var(--font-size-5xl);
`;
const SignupSetup12Root = styled.div`
  position: relative;
  background-color: var(--color-white);
  width: 100%;
  height: 768px;
...
const SignupSetup12 = () => {
  return (
    <SignupSetup12Root>
      ...
      <SignupSetup12Child1 />
      <GroupParent>
        <GroupIcon alt="" src="/group-10579.svg" />
      ...
      <UploadYourInventoryFeedFilWrapper>
        <UploadYourInventory>
          Upload your inventory feed file below.
        </UploadYourInventory>
      </UploadYourInventoryFeedFilWrapper>
      <YourInventoryFeed>
        Your inventory feed will be used to update your vehicle inventory in
        Uobo's app.
      </YourInventoryFeed>
      <Uobo>UOBO</Uobo>
      <TextWelcome>
        <OneLastStep>One Last Step, and we are there.</OneLastStep>
        <StartSellingNow>Start Selling Now</StartSellingNow>
      </TextWelcome>
      <ButtonLogin>
        <ButtonLoginChild />
        <StartSelling>Start Selling</StartSelling>
      </ButtonLogin>
      <InventoryFeedContainer />
    </SignupSetup12Root>
  );
};

export default SignupSetup12;
