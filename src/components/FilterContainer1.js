  ...
  return (
    <FilterGroupRoot>
      ...
      <Body>
        ...
        <SuvCoupe>SUV, Coupe</SuvCoupe>
      </Body>
      <Make>
        <BodyType>Make (21)</BodyType>
        <Path1161Icon alt="" src="/path-11611.svg" />
        <SuvCoupe>Any</SuvCoupe>
      </Make>
      <Models>
      ...
      <LinesIcon alt="" src="/lines2.svg" />
      <SliderIcon alt="" src="/slider.svg" />
    </FilterGroupRoot>
  );
};

export default FilterContainer1;
